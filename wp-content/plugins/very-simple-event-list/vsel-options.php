...
function vsel_admin_init() {
	add_settings_section( 'vsel-section', __( 'General', 'very-simple-event-list' ), '', 'vsel' );
	...
	add_settings_section( 'vsel-section-3', __( 'Page', 'very-simple-event-list' ), '', 'vsel' );
	...
	add_settings_field( 'vsel-field-33', __( 'Event Categories', 'very-simple-event-list' ), 'vsel_field_callback_33', 'vsel', 'vsel-section-3' );
	register_setting( 'vsel-options', 'vsel-setting-33', 'sanitize_text_field' );
	...
	add_settings_section( 'vsel-section-2', __( 'Widget', 'very-simple-event-list' ), '', 'vsel' );
	...
	add_settings_field( 'vsel-field-34', __( 'Event Categories', 'very-simple-event-list' ), 'vsel_field_callback_34', 'vsel', 'vsel-section-2' );
	register_setting( 'vsel-options', 'vsel-setting-34', 'sanitize_text_field' );
...
function vsel_field_callback_33() {
	...
	<label><input type='checkbox' name='vsel-setting-33' <?php checked( $value, 'yes' ); ?> value='yes'> <?php _e( 'Hide on page with all events.', 'very-simple-event-list' ); ?></label>
	<?php
}
